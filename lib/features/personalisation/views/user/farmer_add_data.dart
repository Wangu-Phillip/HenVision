...
class FarmerAddFinances extends StatefulWidget {
  const FarmerAddFinances({super.key});

  @override
  State<FarmerAddFinances> createState() => _FarmerAddFinances();
}

class _FarmerAddFinances extends State<FarmerAddFinances> {
