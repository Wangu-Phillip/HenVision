...
import 'package:hen_vision/features/personalisation/views/user/farmer_dashboard.dart';

import '../../../../common/widgets/drawer.dart';
import '../../services/firestore_service.dart';

class FarmerAddOperations extends StatefulWidget {
  const FarmerAddOperations({super.key});

  @override
  State<FarmerAddOperations> createState() => _FarmerAddOperations();
}

class _FarmerAddOperations extends State<FarmerAddOperations> {
