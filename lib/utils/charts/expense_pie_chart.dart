            ...
            PieChartData(
              ...
              sections: [
                ...
                PieChartSectionData(
                  ...
                  value: totalEquipmentCosts.roundToDouble(),
                  radius: 55,
                  color: Colors.blue,
                ...
                // item-2
                PieChartSectionData(
                  value: totalLaborCosts.roundToDouble(),
                  radius: 55,
                  color: Colors.green,
                ...
                // item-3
                PieChartSectionData(
                  value: totalFeedCosts.roundToDouble(),
                  radius: 55,
                  color: Colors.yellow,
                ...
                // item-4
                PieChartSectionData(
                  value: totalVeterinaryCosts.roundToDouble(),
                  radius: 55,
                  color: Colors.grey,
                  // badgeWidget: const Text("Income"),
                  // badgePositionPercentageOffset: 2,
                ...
                // item-5
                PieChartSectionData(
                  value: totalUtilitiesCosts.roundToDouble(),
                  radius: 55,
                  color: Colors.purple,
                  // badgeWidget: const Text("Income"),
                  // badgePositionPercentageOffset: 2,
